...
$(function () {
                ...
                success : function (text) {
                    ...
                    if (text == 1) {            // 失败
                        ...
                        setTimeout(function () {
                            ...
                            $('#header .reg').hide();
                            $('#header .login').hide();
                            $('#header .info').show().html(getCoolie('user') + '，您好！');
                        }, 1500);
                    }
                    _this.disabled = false;
                    $(_this).css('backgroundPosition', 'left');
    ...
    $('#photo_big .big .right').click(function () {
        ...
        // 这里有一点疑问：attr('index')和index()的区别？？？
        // 前者能正确输出当前图片索引，后者始终是0
        // 后者通过获取当前节点的父节点的所有子节点计算索引值，而#photo_big .big img的父节点值只有一个子节点img，所以索引值始终是0
        // 这里理解有误还需思考
        // 2016-10-12
        ...
        ajax({
            ...
            success : function (text) {
                ...
                $('#skin dl dt img').click(function () {
                    $('body').css('background', $(this).attr('bg_color') + '' + 'url(images/' + $(this).atrr('big_bg') + ') repeat-x');
                    ajax({
                        method : 'post',
                        url : 'get_skin.php',
                        data : {
